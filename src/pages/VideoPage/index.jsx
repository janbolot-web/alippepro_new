    ...
    <div className="video">
      {modules.length > 0 ? (
          ...
          <div className="video__main">
            <div className="video__content">
              <h1 className="video__title">
                {lesson ? lesson.name : lessons?.modules[0]?.lessons[0]?.name}
              </h1>
              <p style={{ backgroundColor: "red" }}>
                Урматтуу мугалимдер, сабактар аманат☝️ <br />
                Сиз алып жаткан билим менен методикалар окуучуларды гана
                окутканга уруксат берилет. Методика автордук укукка ээ.
              </p>
              <div className="video__player">
                ...
                {lesson ? (
                  ...
                  <>
                    <div className="video__not-video ">
                      <p>Выберите видеоурок справа</p>
                      <span>
                        <FaHandPointRight size={34} />
                      </span>
                    </div>
                    <div className="video__not-video-mobile ">
                      <p>Выберите видеоурок внизу</p>
                      <span>
                        <FaHandPointRight size={34} />
                      </span>
                    </div>
              ...
              >
                {" "}
                <p>
                  Бул курсту биздин тиркемеден көрүү учун бул шилтемени басыныз
                </p>{" "}
                <a
              ...
              {lesson?.pdfBook && (
                <div className="dwn">
                  ...
                  <a
                    href="https://drive.google.com/file/d/1ZsFEToRapvPIAbnssRSNXouR7QONUQ8U/view?usp=share_link"
                    target={"_blank"}
                    download
                  >
                    Шар окуу китебинин pdf форматы <span> көчүрүү</span>
                  </a>
                </div>
              )}
              <div className="video__descr">
                ...
                <p>
                  {lesson
                    ? lesson.description
                    : lessons?.modules[0]?.lessons[0]?.description}
                </p>
              </div>
              <div className="video__files">
                <h3>Файлы</h3>
            ...
            <div className="video__sidebar">
              ...
              <ul className="video__list">
                {modules?.map((module, i) =>
                  module?.isAccess === false || module?.price === "0" ? (
                    (module?.courseId === id || module?.price === "0") && (
                      <li className="video__module" key={i}>
                        ...
                        <ol className="video__lessons">
                          {module?.lessons.map((lesson, i) => (
                            <li
                              key={lesson._id}
                              className={`video__lessons-name ${
                                active === lesson._id && "active"
                              }`}
                              onClick={() =>
                                getLesson({
                    ...
                    <li className="video__module disabled" key={i}>
                      <div className="video__header">
                        <p className="video__module-name disabled">
                          {module?.name}
                        </p>
                        <div className="video__right">
                          <Link
                            className="video__lock-btn"
                      ...
                      <ol className="video__lessons">
                        {module?.lessons.map((lesson, i) => (
                          <li
                            key={lesson._id}
                            onClick={() => console.log(module?.price)}
                            className={`video__lessons-name`}
                            disabled
                          >
                            {lesson.name}{" "}
        ...
        <div className="container not-found">
          <h1>Вы еще не приобрели ни одного курса</h1>
